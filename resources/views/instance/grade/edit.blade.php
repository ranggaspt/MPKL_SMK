...
<div class="content">
    <form action="{{ route('instance.grade.update', Crypt::encrypt($grades->id)) }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        <div class="row">
            <div class="col-lg-8 order-lg-1">
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <h4 class="m-0 font-weight-bold text-white">Edit Instansi</h4>
                    </div>
                    <div class="card-body">
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('student_id') ? ' has-error' : '' }}">
                                ...
                                <div>
                                    <select class="form-control" name="student_id" required>
                                        ...
                                        <option value="{{$students->id}}" {{$students->student_id == $students->id ? 'selected' : ''}}>{{$students->name}}</option>
                                        @empty
                            ...
                            <div class="form-group{{ $errors->has('option_1') ? ' has-error' : '' }}">
                                ...
                                <input id="option_1" type="number" class="form-control" name="option_1" value="{{ $grades->option_1 }}" required>
                            ...
                            <div class="form-group{{ $errors->has('option_2') ? ' has-error' : '' }}">
                                ...
                                <input id="option_2" type="number" class="form-control" name="option_2" value="{{ $grades->option_2 }}" required>
                            ...
                            <div class="form-group{{ $errors->has('option_3') ? ' has-error' : '' }}">
                                ...
                                <input id="option_3" type="number" class="form-control" name="option_3" value="{{ $grades->option_3 }}" required>
                            ...
                            <div class="form-group{{ $errors->has('option_4') ? ' has-error' : '' }}">
                                ...
                                <input id="option_4" type="number" class="form-control" name="option_4" value="{{ $grades->option_4 }}" required>
                            ...
                            <div class="form-group{{ $errors->has('option_5') ? ' has-error' : '' }}">
                                ...
                                <input id="option_5" type="number" class="form-control" name="option_5" value="{{ $grades->option_5 }}" required>
