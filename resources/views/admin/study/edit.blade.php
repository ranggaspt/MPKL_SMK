...
<div class="content">
    <form method="POST" action="{{ route('admin.study.update', Crypt::encrypt($data->id)) }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header">
                    <h4 class="m-0 font-weight-bold text-white">Edit Jurusan</h4>
                </div>
                <div class="card-body">
                    <div class="pl-lg-4">
