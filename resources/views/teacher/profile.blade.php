...
<form method="POST" action="{{ route('teacher.profile.update') }}" autocomplete="off" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('PUT') }}
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                                    ...
                                    <textarea id="address" class="form-control" name="address" required>{{ $data->address }}</textarea>
